...
public class SwaggConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.example.Error_Notes"))
    ...
    private ApiInfo metaData() {
        return new ApiInfoBuilder()
                ...
                .contact(new Contact("Api by FC&AM", "https://github.com/FatouDev02", "fatoumatacoulibaly4155@gmail.com"))
                .build();
    }
